...
public class RecorderDialog2 extends Dialog {
    public RecorderDialog2(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public RecorderDialog2 create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final RecorderDialog2 dialog = new RecorderDialog2(context, R.style.Dialog);
            ...
            if (message != null) {
                ...
                ((LinearLayout) layout.findViewById(R.id.content)).addView(
                        contentView, new WindowManager.LayoutParams(
